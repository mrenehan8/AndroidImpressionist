    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ImpressionistView myView = (ImpressionistView) findViewById(R.id.viewImpressionist);
                myView.savePainting();
        ...
        Button blackWhite = (Button)findViewById(R.id.bwButton);
        blackWhite.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ImpressionistView myView = (ImpressionistView) findViewById(R.id.viewImpressionist);
                myView.setBlackAndWhite();
                //myView.setDrawingCacheBackgroundColor(Color.WHITE);

            }
        });

        Button color = (Button)findViewById(R.id.colorButton);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuSquare:
                ...
                return true;
            case R.id.menuSquarePressure:
                Toast.makeText(this, "Square Pressure Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.SquarePressure);
                return true;
        }
        return false;
    }
